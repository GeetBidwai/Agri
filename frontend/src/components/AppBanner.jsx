function AppBanner({ language }) {
  const text = language === "HI"
    ? {
        title: "AgriMandi ऐप डाउनलोड करें",
        subtitle: "कभी भी, कहीं भी व्यापार करें",
      }
    : {
        title: "Get the AgriMandi App",
        subtitle: "Trade commodities anytime, anywhere",
      };
    ...
    <section className="bg-gray-50 py-14 px-6">
      <div className="max-w-6xl mx-auto bg-green-800 rounded-2xl p-10 flex flex-col md:flex-row justify-between items-center text-white">
        <div>
          ...
          <p className="text-white/80 mt-2 text-sm">{text.subtitle}</p>
